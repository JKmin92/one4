...
router.post("/product/inquiry/:product_code", authMiddleware, upload.array('images', 10), boardController.insertProductInquiry);
router.get("/product/inquiry/:product_code", boardController.getProductInquiryByProductCode);
