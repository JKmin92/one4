import { Box, Circle, Flex, Float, HStack, Icon, IconButton, Image, Stack, Text, Popover, Button, Portal } from "@chakra-ui/react";
...
export default function CampaignActivityPopover() {
    ...
    return (
        <Popover.Root open={isOpen} onOpenChange={(e) => { if (e.open) handleOpen(); else setIsOpen(false); }} positioning={{ placement: "bottom-end" }}>
            ...
            <Portal>
                <Popover.Positioner>
                    <Popover.Content width="320px" p="0" overflow="hidden" shadow="lg" rounded="md" bg="white">
