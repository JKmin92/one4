...
import axiosInstance from "../../../../utils/api.jsx";
                                        ...
                                        onFileAccept={async (accepted) => {
                                            ...
                                            if (uploaded[0]) {
                                                ...
                                                try {
                                                    ...
                                                    const res = await axiosInstance.post('/admin/review/notice/upload', formData, {
                                                        headers: { 'Content-Type': 'multipart/form-data' }
                                                    });
                                                    
                                                    if (res.data.success && res.data.url) {
                                                        // Convert relative upload path to full URL depending on your frontend setup, 
                                                        // but since Vite proxies /uploads to backend, a root-relative path works.
...
function NoticeEditor({ content, setContent }) {
    ...
    return (
        <RichTextEditor.Root editor={editor} w="full" minH="400px" overflow="auto">
...
export default memo(NoticeEditor);
