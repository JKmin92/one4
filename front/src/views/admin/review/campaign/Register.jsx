...
function Register() {
    ...
    const [minPhotoCount, setMinPhotoCount] = useState(0);
    const [minTextLength, setMinTextLength] = useState(0);
        ...
        <Stack p="30px" px="layoutX" gap="10" pb="20">
            ...
            <Stack gap="6" borderWidth="1px" p="6" borderRadius="md">
                ...
                <Field.Root>
                    ...
                    <HStack gap="6">
                        <Checkbox.Root checked={channels.includes('blog')} onCheckedChange={() => handleChannelToggle('blog')}>
                            <Checkbox.HiddenInput />
                            <Checkbox.Control />
                            <Checkbox.Label>블로그</Checkbox.Label>
                        </Checkbox.Root>
                        <Checkbox.Root checked={channels.includes('instagram')} onCheckedChange={() => handleChannelToggle('instagram')}>
                            <Checkbox.HiddenInput />
                            <Checkbox.Control />
                            <Checkbox.Label>인스타그램</Checkbox.Label>
                        </Checkbox.Root>
                        <Checkbox.Root checked={channels.includes('youtube')} onCheckedChange={() => handleChannelToggle('youtube')}>
                            <Checkbox.HiddenInput />
                            <Checkbox.Control />
                            <Checkbox.Label>유튜브</Checkbox.Label>
                        </Checkbox.Root>
                        <Checkbox.Root checked={channels.includes('tiktok')} onCheckedChange={() => handleChannelToggle('tiktok')}>
                            <Checkbox.HiddenInput />
                            <Checkbox.Control />
                            <Checkbox.Label>틱톡</Checkbox.Label>
                        </Checkbox.Root>
                    </HStack>
                </Field.Root>
            </Stack>
                        ...
                        <Stack gap="4">
                            ...
                            <HStack gap="6">
                                ...
                                {(reward.reward_type === 'PRODUCT' || reward.reward_type === 'COUPON') && (
                                    <Field.Root flex="1">
                                        <Field.Label mb="2">제공 수량</Field.Label>
                                        <Input 
                                            bg="white"
                                            type="number" 
